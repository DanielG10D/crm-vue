...
const actualizarEstado = ({id, estado}) => {
    ClienteService.cambiarEstado(id, {estado: !estado})
      .then(() => {
          const i = clientes.value.findIndex(cliente => cliente.id === id) //Esta const i es para que cuando hagamos click! sobre activo o inactivo y cambie su estado, es para no refrescar la pagina y lo haga en automaticatico
